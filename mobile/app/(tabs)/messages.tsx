import { CONVERSATIONS, ConversationType, MessageType } from "@/data/conversation";
...
const MessagesScreen = () => {
  ...
  const deleteConversation = (conversationId: number) => {
    Alert.alert("Delete Conversation", "Are you sure you want to delete this conversation?", [
      { text: "Cancel", style: "cancel" },
      {
        ...
        style: "destructive",
        onPress: () => {
          setConversationsList((prev: ConversationType[]) => prev.filter((conv) => conv.id !== conversationId));
        },
      },
    ]);
  };
  ...
  const sendMessage = () => {
    if (newMessage.trim() && selectedConversation) {
      ...
      setConversationsList((prev: ConversationType[]) =>
        prev.map((conv) =>
